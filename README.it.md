...
- **Compatibile multi-batteria.** I sistemi Pylontech concatenati (fino a 4 unità, 64 celle) vengono rilevati e riportati singolarmente, non solo come un aggregato mediato.
...
| **Supporto multi-batteria** | Fino a 4 unità Pylontech concatenate (64 celle totali) rilevate e mostrate singolarmente, con un selettore per "tutte le batterie combinate" o ogni singola unità. |
...
<p align="center">
  <img src="https://pylon-monitor.com/assets/img/screenshots/pylon-monitor-dashboard-pylontech-monitoring.webp" alt="Dashboard web live di Pylon-Monitor con carica, salute, temperature, celle e storico 24h della batteria Pylontech" width="480">
