...
- **Mehrbatterien-fähig.** Verkettete Pylontech-Systeme (bis zu 4 Einheiten, 64 Zellen) werden einzeln erkannt und gemeldet, nicht nur als ein gemitteltes Ganzes.
...
| **Mehrbatterien-Unterstützung** | Bis zu 4 verkettete Pylontech-Einheiten (64 Zellen insgesamt) werden erkannt und einzeln angezeigt, mit einer Auswahl für „alle Batterien kombiniert" oder jede einzelne Einheit. |
